...
func easyjson9e1087fdDecodeGithubComVoyakinHLokleBackendInternalModels(in *jlexer.Lexer, out *Parent) {
...
func easyjson9e1087fdEncodeGithubComVoyakinHLokleBackendInternalModels(out *jwriter.Writer, in Parent) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson9e1087fdDecodeGithubComVoyakinHLokleBackendInternalModels1(in *jlexer.Lexer, out *Credentials) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9e1087fdEncodeGithubComVoyakinHLokleBackendInternalModels1(out *jwriter.Writer, in Credentials) {
	out.RawByte('{')
	first := true
	_ = first
	{
